...
<html class="no-js" lang="en">
  ...
  <body>
      ...
      <nav class="top-bar fixed" data-topbar role="navigation">
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
            ...
            <li class="active"><a href="<?=base_url()?>index.php/servicios">Servicios</a></li>
    ...
    <li>
        <img src="<?=base_url()?>assets/img/bg7.jpg" alt="slide 1" />

    </li>
    <li>
        <img src="<?=base_url()?>assets/img/bg8.jpg" alt="slide 1" />

    </li>
    <li>
        <img src="<?=base_url()?>assets/img/bg10.jpg" alt="slide 1" />

    </li>
    <li>
        <img src="<?=base_url()?>assets/img/bg9.jpg" alt="slide 1" />
...
<div class='titulo'>
  <div class="row">
    <div class="small-12 medium-6 large-6 columns">Servicios</div>
  </div>
</div>
...
<div class="row">
    <div class="large-12 columns">
      <h1>Nos interesa brindar servicios de alto valor agregado con tecnologías inovadoras que harán que tu empresa este a la vanguradia en las telecomunicaciones.</h1>
      <hr>
    </div>
  </div>
...
<div class="pymes">
  <div class="row">
    <div class="small-12 medium-6 large-6 columns">Las PyMES en México están requiriendo cada vez más tecnologías que se adapten a su medida, que vayan creciendo al ritmo que las empresas crecen. No todas las empresas cuentan con un responsable para cada área, llámese voz, datos, video vigilancia, seguridad, etc. Inclusive se da el caso en que no haya personal responsable de las tecnologías, Sereteli te acompaña paso a paso.</div>
...
<div class='sere'>
<div class="row">
  <div class="small-12 medium-6 large-6 columns"><p>¿Eres una empressa en crecimiento? No esperes mas y ponte con contacto con nosotros, tenemos las soluciones perfectas para ti.</p></div>
  <div class="small-12 medium-6 large-6 columns"><a href="#" class="expand radius button secondary">Escríbenos</a><br/></div>
</div>
        ...
        <div id="contenido_video">
            <div class="row">
                ...
                <div class="container text-center">
                    <!-- <img src="<?=base_url()?>assets/img/mit.png"  /> -->
                    <div id="rerrr"></div>
                </div>
            </div>
        </div>
...
<div class="pymes2">
  <div class="row">
  <div class="small-12 medium-4 large-4 columns"><center><img src="<?=base_url()?>assets/img/mit.png"/></center></div>
    <div class="small-12 medium-8 large-8 columns">Mitel (antes Ericsson-Aastra) para el equipamiento de voz como equipos robustos PBX, Telefonía IP, Videoconferencia así como accesorios, refacciones terminales telefónicas digitales, analógicas SIP e IP.</div>
  </div>
...
<div class="pymes3">
  <div class="row">
    ...
    <div class="small-12 medium-8 large-8 columns">NEC comercializamos, instalamos, damos servicio de capacitación, soporte y mantenimiento a PBX dirigidos a PYMES.</div>
  <div class="small-12 medium-4 large-4 columns"><center><img src="<?=base_url()?>assets/img/nec.png"/></center></div>
  </div>
...
(function ($, document, window) {
  ...
  function play(that) {
    ...
    if (video.paused) {
      video.play();
      $("#btnplay").removeClass();
      $("#btnplay").addClass("fa fa-pause fa-stack-1x fa-inverse");
      // controller.toggleClass('ui-icon-pause ui-icon-play').text(that.settings.controlText[1]);
    } else {
      if (video.ended) {
        video.play();
        $("#btnplay").removeClass();
        $("#btnplay").addClass("fa fa-play fa-stack-1x fa-inverse");
        // controller.toggleClass('ui-icon-pause ui-icon-play').text(that.settings.controlText[1]);
      } else {
        video.pause();
        $("#btnplay").removeClass();
  ...
  function mute(that) {
    ...
    if (video.volume === 0) {
      video.volume = 1;
      $("#btnsound").removeClass();
      $("#btnsound").addClass("fa fa-volume-up fa-stack-1x fa-inverse");
      // controller.toggleClass('ui-icon-volume-on ui-icon-volume-off').text(that.settings.controlText[2]);
    } else {
      video.volume = 0;
      $("#btnsound").removeClass();
      $("#btnsound").addClass("fa fa-volume-off fa-stack-1x fa-inverse");
      ...
      return this.each(function () {
        ...
        if (document.createElement('video').canPlayType) {
          ...
          if (!that.settings.initialised) {
            ...
            that.controls = $('<div class="ui-video-background-controls"><div class="row"><div class="small-12 medium-2 large-2 columns"><div class="ui-video-background-play">'
              + '<a class="ui-icon ui-icon-pause" href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i id="btnplay" class="fa '+that.settings.controlText[1]+' fa-stack-1x fa-inverse"></i></span></a>'
              + '</div></div><div class="small-12 medium-2 large-2 columns"><div class="ui-video-background-mute">'
              + '<a class="ui-icon ui-icon-volume-on" href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i id="btnsound" class="fa '+that.settings.controlText[2] +' fa-stack-1x fa-inverse"></i></span></a>'
              + '</div></div></div></div>');
            /*
  ...
  $.fn.videobackground.defaults = {
    ...
    preload: 'auto',
    loop: false,
    controlText: ['fa-play', 'fa-pause', 'fa-volume-off', 'fa-volume-up'],
    resize: true,
    preloadHtml: '',
...
<script>
            $(document).ready(function() {
                $('#video2').videobackground({
                    videoSource: [['<?=base_url()?>video.mp4', 'video/mp4']],
